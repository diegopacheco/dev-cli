...
var helpSections = []helpSection{
	...
	{"MODES", theme.Magenta, []helpRow{
		...
		{"-loki LOGQL", "query Loki · labels · values LABEL · :range 30m · :limit 100"},
		{"-grafana COMMAND", "health · search · dashboard UID · datasources · query DS EXPR · get /api/..."},
		{"-prometheus PROMQL", "instant query · metrics · labels · targets · alerts · :range 1h"},
